...
class Metaclass_Contact(type):
    ...
    def PHONE_TYPE_HOME(self):
        ...
        return Metaclass_Contact.__constants['PHONE_TYPE_HOME']

    @property
    def PHONE_TYPE_WORK(self):
        """Message constant 'PHONE_TYPE_WORK'."""
        return Metaclass_Contact.__constants['PHONE_TYPE_WORK']

    @property
    def PHONE_TYPE_MOBILE(self):
        """Message constant 'PHONE_TYPE_MOBILE'."""
        return Metaclass_Contact.__constants['PHONE_TYPE_MOBILE']
