  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: address_book
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      rosidl_tutorials_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.address_book[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: address_book
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rosidl_tutorials_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.address_book[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: address_book
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rosidl_tutorials_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Contact(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
