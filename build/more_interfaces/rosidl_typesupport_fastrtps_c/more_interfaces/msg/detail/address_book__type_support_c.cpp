  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: address_book
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_rosidl_tutorials_msgs__msg__Contact(
        &array_ptr[i], cdr);
    }
  }
  ...
  more_interfaces__msg__AddressBook * ros_message)
{
  // Field name: address_book
  {
    ...
    if (!rosidl_tutorials_msgs__msg__Contact__Sequence__init(&ros_message->address_book, size)) {
      fprintf(stderr, "failed to create array for field 'address_book'");
      return false;
    }
    auto array_ptr = ros_message->address_book.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_rosidl_tutorials_msgs__msg__Contact(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, address_book) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: address_book
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_rosidl_tutorials_msgs__msg__Contact(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: address_book
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_rosidl_tutorials_msgs__msg__Contact(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: address_book
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_rosidl_tutorials_msgs__msg__Contact(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
